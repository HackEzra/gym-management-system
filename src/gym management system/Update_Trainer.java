...
//        p1.add(tf7);
    ...
    public void actionPerformed(ActionEvent e)
    {
           ...
           try {
               ...
               String q= "update add_trainer set name='"+name+"',fname='"+fname+"',email='"+email+"',address='"+address+"',contactNo='"+cont+"',emergencyNo='"+eno+"',category='"+tcat+"',min_aggrement='"+minag+"',gender='"+gender+"',height='"+height+"',weight='"+weight+"',remarks='"+remarks+"' where tid='"+tid+"'";
